...
st.markdown("""
            <div class "center">
                <img src= "https://media.tenor.com/oqJo9GcbfjYAAAAi/welcome-images-serve.gif" alt = "Welcome Image" >
            <div>
            """, unsafe_allow_html=True)
st.markdown("<h1 style= 'text-align: center; color: #4CAF50;' > Prediksi IPK - 1668 </h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory= r'D:\Semester 5\Pembelajaran mesin dan Pembelajaran Mendalam\Modul supervised\Tugas3_B_11683'
    ...
    if os.path.exists(model_path):
        ...
        st.sidebar.subheader("Massukan Nilai")
        ...
        kkm_mtk1 = st.sidebar.number_input("KKM Nilai Bahasa Matematika Semester 1.1", 0.0, 100.0)
        kkm_mtk2 = st.sidebar.number_input("KKM Nilai Bahasa Matematika Semester 1.2", 0.0, 100.0)
        kkm_mtk3 = st.sidebar.number_input("KKM Nilai Bahasa Matematika Semester 2.1", 0.0, 100.0)
        kkm_mtk4 = st.sidebar.number_input("KKM Nilai Bahasa Matematika Semester 2.2", 0.0, 100.0)
